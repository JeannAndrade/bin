...
## Abrir Workspace no VS Code (vscode-open-workspace.zsh)
...
## Criar Novo Projeto Blazor (dotnet-new-blazor-app.zsh)
...
## Verificar e Atualizar Pacotes .NET (dotnet-update-packages.zsh)
